...
#define COMMANDREGISTER_WRITELOCK 0xFE
#define UNLOCK_KEY 0xC5
#define INTERRUPTMASKREGISTER 0xF0
#define INTERRUPTSTATUSREGISTER 0xF1
#define IDREGISTER 0xFC

#define PAGE_PWM0 0x00       // PG0
#define PAGE_PWM1 0x01       // PG1
#define PAGE_SCALING_0 0x02  // PG2
#define PAGE_SCALING_1 0x03  // PG3
#define PAGE_FUNCTION 0x04   // PG4

#define REG_CONFIGURATION 0x00  // PG4
